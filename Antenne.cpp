...
Antenne::Antenne(Point position, double puissanceEmission, double frequence, std::string nom) :
	d_position{ position }, d_puissanceEmission{ puissanceEmission }, d_frequence{ frequence }, d_nom{ nom }
{}
